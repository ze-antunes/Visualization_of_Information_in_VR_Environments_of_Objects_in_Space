...
export default class ManoeuvreInfo {
    constructor() {
    ...
    setInfo() {
        ...
        this.manoeuvresStatus.add(
            new ThreeMeshUI.Text({ content: "Manoeuvres Types", fontSize: 0.06 })
        );
    ...
    setPopupCard() {
        this.cardNtext = new ThreeMeshUI.Block({
            textAlign: 'left',
            backgroundOpacity: 0,
            borderWidth: 0
        });
        ...
        // PopupCard
        this.popupCard = new ThreeMeshUI.Block({
            width: 1.2,
            margin: 0.02,
            backgroundColor: new THREE.Color("#505050"),
            backgroundOpacity: 1,
        ...
        // //Text
        // this.text = new ThreeMeshUI.Block({
        //     width: 1.2,
        //     height: 0.1,
        //     justifyContent: 'center',
        //     textAlign: 'left',
        ...
        this.popupCard.add(this.tcaBlock, this.typeBlock, this.durationBlock, this.pocBlock, this.missDistanceBlock)
        this.cardNtext.add(this.popupCard)
        
        return this.cardNtext
    }
